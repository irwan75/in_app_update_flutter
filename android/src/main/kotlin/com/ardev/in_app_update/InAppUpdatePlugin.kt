package com.ardev.in_app_update
...
/** InAppUpdatePlugin */
class InAppUpdatePlugin: FlutterPlugin, MethodCallHandler,PluginRegistry.ActivityResultListener, Application.ActivityLifecycleCallbacks, ActivityAware {
  ...
  private fun checkForUpdate(result: Result) {
    ...
    appUpdateManager = AppUpdateManagerFactory.create(activityProvider?.activity()!!.baseContext)
